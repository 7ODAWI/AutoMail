...
public abstract class AutoMailWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
{
    protected static readonly Lazy<string> ContentRootFolder;

    static AutoMailWebTestBase()
    {
    ...
    protected override IWebHostBuilder CreateWebHostBuilder()
    {
        return base
            ...
            .UseSetting(WebHostDefaults.ApplicationKey, typeof(AutoMailWebMvcModule).Assembly.FullName);
    }
    ...
    {
        using (var context = IocManager.Resolve<AutoMailDbContext>())
        {
            action(context);
            context.SaveChanges();
        }
    ...
    protected async Task UsingDbContextAsync(Func<AutoMailDbContext, Task> action)
    {
        using (var context = IocManager.Resolve<AutoMailDbContext>())
        {
    ...
    protected async Task<T> UsingDbContextAsync<T>(Func<AutoMailDbContext, Task<T>> func)
    {
        T result;
