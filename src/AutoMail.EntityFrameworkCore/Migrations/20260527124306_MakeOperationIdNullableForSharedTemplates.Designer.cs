...
namespace AutoMail.Migrations
{
    ...
    [Migration("20260527124306_MakeOperationIdNullableForSharedTemplates")]
    partial class MakeOperationIdNullableForSharedTemplates
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AutoMail.Project_Models.AiGeneratedTemplateVersion", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<string>("ComponentOrderJson")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.HasIndex("StructureHash");

                    b.HasIndex("SubjectHash");

                    b.HasIndex("OperationId", "CreationTime");

                    b.ToTable("AiGeneratedTemplateVersions", (string)null);
                });
            ...
            modelBuilder.Entity("AutoMail.Project_Models.AiGenerationRun", b =>
                {
                    ...
                    b.Property<int>("GeneratedVariants")
                        .HasColumnType("int");
                    ...
                    b.ToTable("AiGenerationRuns", (string)null);
                });

            modelBuilder.Entity("AutoMail.Project_Models.AiTemplateProfile", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<int>("SourceTemplateCount")
                        .HasColumnType("int");
                    ...
                    b.ToTable("AiTemplateProfiles", (string)null);
                });

            modelBuilder.Entity("AutoMail.Project_Models.EmailOperation", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<byte>("AiGenerationMode")
                        .HasColumnType("tinyint");

                    b.Property<DateTime?>("AiLastGeneratedAt")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<bool>("AiTemplatesGenerated")
                        .HasColumnType("bit");
                    ...
                    b.ToTable("EmailOperations", (string)null);
                });

            modelBuilder.Entity("AutoMail.Project_Models.EmailSender", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AutoMail.Project_Models.EmailTemplate", b =>
                {
                    ...
                    b.Property<long?>("AiGeneratedVersionId")
                        .HasColumnType("bigint");

                    b.Property<long?>("AiGenerationRunId")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("AiGeneratedVersionId");

                    b.HasIndex("AiGenerationRunId");
            ...
            modelBuilder.Entity("AutoMail.Project_Models.OperationEmail", b =>
                {
                    ...
                    b.ToTable("OperationEmails", (string)null);
                });
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("AutoMail.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("AutoMail.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("AutoMail.Project_Models.AiGeneratedTemplateVersion", b =>
                {
                    b.HasOne("AutoMail.Project_Models.AiGenerationRun", null)
                        .WithMany()
            ...
            modelBuilder.Entity("AutoMail.Project_Models.EmailTemplate", b =>
                {
                    b.HasOne("AutoMail.Project_Models.AiGeneratedTemplateVersion", null)
                        .WithMany()
                        .HasForeignKey("AiGeneratedVersionId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("AutoMail.Project_Models.AiGenerationRun", null)
                        .WithMany()
                        .HasForeignKey("AiGenerationRunId")
                        .OnDelete(DeleteBehavior.NoAction);
            ...
            modelBuilder.Entity("AutoMail.Project_Models.OperationEmail", b =>
                {
                    ...
                    b.HasOne("AutoMail.Project_Models.EmailSender", "Sender")
                        .WithMany()
